...
mean_aucs_to_plot = zeros(length(list_of_features_to_try) * length(fractal_dimensions), length(list_of_problems_to_try));
% standard deviations for the roc curves
stds_aucs_to_plot = zeros(length(list_of_features_to_try) * length(fractal_dimensions), length(list_of_problems_to_try));
